<template>
  ...
  >
    ...
    <a
      href="#/guanggao2" target="_self"
    ><img src="https://www.keaidian.com/uploads/allimg/190424/24110307_35.jpg" width="320" border="0" />
    </a>
  </div>
</template>
...
export default {
  ...
  beforeDestroy () {
    this.$message.warning('this.clearFdAd')
    this.clearFdAd()
  },
  methods: {
    // guanggao () {
    //   this.$router.push({ path: '/guanggao' })
    // },
    changePos () {
